                ...
                <form class="form-body row g-3" action={{ route('register') }} method="POST">
                  ...
                  <div class="col-12 col-lg-12">
                    <div class="social-login d-flex flex-row align-items-center justify-content-center gap-2 my-2">
                      <a href="javascript:;" class=""><img src={{ asset('fobiaadmin-10/ltr/assets/images/icons/facebook.png') }} alt=""></a>
                      <a href="javascript:;" class=""><img src={{ asset('fobiaadmin-10/ltr/assets/images/icons/apple-black-logo.png') }} alt=""></a>
                      <a href="javascript:;" class=""><img src={{ asset('fobiaadmin-10/ltr/assets/images/icons/google.png') }} alt=""></a>
                    </div>
                  </div>
